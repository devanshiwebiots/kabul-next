...
import DismissibleAlerts from "@/Components/Forms&Table/Tables/ReactStrapTables/TableComponents/Common/DismissibleAlerts";
import AlertsWithIcons from "@/Components/Forms&Table/Tables/ReactStrapTables/TableComponents/Common/AlertsWithIcons";
    ...
    tableColData: (
      <Alert color="primary">
        <p>
          ...
          <Link className="alert-link text-warning" href={Href}> read this message</Link>
          .
        </p>
      </Alert>
    ),

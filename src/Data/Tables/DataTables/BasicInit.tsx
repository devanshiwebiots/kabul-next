...
import { CustomCellInterFace, ScrollImageType, ScrollTableActionType, ScrollVerticalType, StateSavingTableDataType, TableActionType, TableActionTypes, ZeroConfigurationTableColumnsType } from "@/Types/Tables";
...
export const StateSavingDataList = [
  ...
  const ScrollTableActions: React.FC<ScrollTableActionType> = ({ id }) => {
    return (
      <ul className="action" id={id}>
        <li className="edit">
          <a href={Href}>
  ...
  export const ScrollVerticalColumns = [
    ...
    {
      name: "Action",
      cell: (row: ScrollVerticalType) => <ScrollTableActions id={row.action} />,
      sortable: true,
    },
  ];
  ...
  const ZeroConfigurationTableAction = ({ id }: TableActionType) => {
    return (
      <ul className="action" id={id}>
        <li className="edit">
          <Link href={Href}>
  ...
  export const ZeroConfigurationColumn = [
    ...
    {
      name: "Action",
      cell: (row: ZeroConfigurationTableColumnsType) => <ZeroConfigurationTableAction id={row.action} />,
      sortable: true,
    },
  ];
...
const ScrollImage: React.FC<ScrollImageType> = ({ image, title }) => {
  return (
    <>
      <Image height={32} width={32} priority className="img-fluid table-avtar" src={`${ImagePath}/user/${image}`} alt="userImage" /> {title}
    </>
  );
};
...
export const ZeroConfigurationColumn = [
  ...
  {
    name: "Action",
    cell: (row: ZeroConfigurationTableColumnsType) => <TableActions id={row.action} />,
    sortable: true,
  },
];
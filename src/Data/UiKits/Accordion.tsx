...
export const SimpleAccordion1: string = " <p> Web design <em class='txt-danger'>identifies the goals</em> of a website or webpage and promotes accessibility for all potential users. This process involves organizing content and images across a series of pages and integrating applications and other interactive elements.</p>"
...
export const AccordionList = [
  {
    ...
    bodyText: <div dangerouslySetInnerHTML={{ __html: SimpleAccordion1 }}></div>,
  },
  {
    id: "2",
    icon: true,
...
export const AccordionIconList = [
  {
    ...
    bodyText: <div dangerouslySetInnerHTML={{ __html: IconAccordion1 }}></div>,
  },
  {
    id: "2",
...
export const FlushAccordion1: string = ` <p>--> Bootstrap is the most popular HTML, CSS and JavaScript framework for developing a responsive and mobile friendly website.<br />--> It is absolutely free to download and use.</p>`
...
export const FlushList = [
  {
    ...
    bodyText: <div dangerouslySetInnerHTML={{ __html: FlushAccordion1 }}></div>,
  },
  {
    id: "2",
    accordionHeaderClass: "bg-light-success",

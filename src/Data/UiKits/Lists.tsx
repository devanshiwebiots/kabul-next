export const DefaultData = [
  ...
  export const DefaultListData = ["Logo Design","Web Design & Development", "E-Commerce", "SEO"];
  ...
  export const ActiveListData = ["UI Kits","Wow Animations", "Apex Charts", "Starter Kits"];
  ...
  export const FlushListData = ["PRODUCT","PRODUCT DETAILS","CART","CHECKOUT"]
  ...
  export const ContextualDataList = ["primary","secondary", "success", "danger", "warning", "info", "white", "dark"];
  ...
  export const HorizontalListData = [
    {
      color: "primary",
      item: ["Product","Product details", "Pricing", "Payment details", "Checkout ", "Mega options "],
    },
    {
      color: "secondary",
  ...
  export const CustomList = [
    {
      ...
      days: "5 days ago",
      text: "Next step is to choose a tone of voice for your content type. From casual to convincing, pick one from 20+ tones in the dropdown.Why did we say “snag eyeballs” instead of “get attention?” Why do we say “brick-and-mortar words” instead of “concrete words?” Because, in your email subject lines, it’s better to use words that people can picture.",

...
export const LeftRibbonsDataList = [
    {
        className: "ribbon-wrapper alert-light-light bg-light-primary",
        ribbonClass: "ribbon-primary ribbon-space-bottom",
        title: "SAVE 10%",
        span: [
            {
                text: "Ribbon designs",
                spanText: " have been a part of web design. There is a design for you in this collection, regardless of whether you use",
            },
            {
                text: " CSS ribbons",
                spanText: " to identify your items."
            },
        ],
    },
    {
    ...
    {
        className: "ribbon-vertical-left-wrapper vertical-lp-space alert-light-light bg-light-primary",
    ...
    {
        className: "ribbon-wrapper-bottom clip-bp-space alert-light-light bg-light-primary",
...
export const RightRibbonDataList = [
    {
        className: "ribbon-wrapper",
        ribbonClass: "ribbon-dark ribbon-right",
        title: "50% OFF",
        span: [
            {
                text: "The ",
    ...
    {
        className: "ribbon-wrapper-right alert-light-light bg-light-primary",
    ...
    {
        className: "ribbon-vertical-right-wrapper vertical-rp-space alert-light-light bg-light-primary",

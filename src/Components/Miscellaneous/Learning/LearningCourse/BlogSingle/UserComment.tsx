...
import { UserCommentPropsType } from "@/Types/Learning";
        ...
        <ul className="mx-0">
          <li>
            <div className="d-flex align-self-center">
              <Image height={74} width={74} priority className="align-self-center" src={`${ImagePath}/blog/${ImageSrc}`} alt="Generic placeholder" />

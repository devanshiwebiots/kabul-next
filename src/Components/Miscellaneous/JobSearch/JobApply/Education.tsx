...
import { CollegePlaceholder, CollegeNameJob, DegreeLevelJob, DegreePlaceholder, PeriodJob, SpecializationJob, SpecializationPlaceholder } from "@/Constant";
import { TypeHeadOptionsData } from "@/Data/Miscellaneous/JobSearch";
      ...
      <Row>
        <Col xl={6} className="xl-100">
          <FormGroup>
            ...
            <Input type="text" placeholder={CollegePlaceholder} />
          </FormGroup>
        </Col>
        <Col xl={6} className="xl-100">

import { ApplyForThisJob, EndLessDesigner, Href, ImagePath, ProductDesignerMainCard, SimilarJobs, StarColor } from "@/Constant";
        ...
        <div className="job-search">
          <CardBody>
            <div className="d-flex">
              <Image height={36} width={33} priority className="b-r-0 img-fluid m-r-20" src={`${ImagePath}/job-search/1.png`} alt="job-search" />

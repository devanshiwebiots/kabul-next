...
const TicketTable = () => {
  ...
  return (
    <div className='table-responsive basic-data-table'>
      ...
      <DataTable className='custom-scrollbar' columns={SupportColumnData} data={filteredItems} striped={true} pagination selectableRows onSelectedRowsChange={handleRowSelected} clearSelectedRows={toggleDelete} />
    </div>
  );
};

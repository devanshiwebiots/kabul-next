import { CommonFloatingInputProp } from "@/Types/Forms";
import { Col, FormGroup, Input, Label, Row } from "reactstrap";

const FloatingInputField: React.FC<CommonFloatingInputProp> = ({ inputType, label, floatingLabel, placeholder, defaultValue, height, invalid }) => {
  return (
    <Row className="mb-1">

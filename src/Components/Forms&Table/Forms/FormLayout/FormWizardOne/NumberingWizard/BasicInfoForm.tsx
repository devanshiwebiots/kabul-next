...
import { AgreeToTermsAndConditions, KabulMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, FirstName, Password } from "@/Constant";
import { NumberingWizardPropsType } from "@/Types/Forms";
      ...
      <Row>
        <Col sm={6}>
          <FormGroup>
            ...
            <Input onChange={getUserData} value={email} name="email" type="email" placeholder={KabulMail} />
          </FormGroup>
        </Col>
        <Col sm={6}>
          <FormGroup>

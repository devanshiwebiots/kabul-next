...
import { Address, KabulMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName } from "@/Constant";
import { BillingUserDetailsProp } from "@/Types/Forms";
  ...
  return (
    <>
      ...
      <Col sm={6}>
        ...
        <Input value={email} onChange={getUserData} name="email" type="email" placeholder={KabulMail} />
      </Col>
      <Col sm={12}>

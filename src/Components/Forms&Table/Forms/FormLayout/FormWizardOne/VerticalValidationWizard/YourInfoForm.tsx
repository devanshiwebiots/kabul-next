...
import { AgreeToTermsAndConditions, KabulMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, Next, State, ZipCode } from "@/Constant";
import { VerticalValidationWizardFormPropsType } from "@/Types/Forms";
      ...
      <Row>
        ...
        <Col xxl={4} sm={6}>
          <FormGroup>
            ...
            <Input name="email" type="email" placeholder={KabulMail} value={email} onChange={getUserData} />
          </FormGroup>
        </Col>
        <Col xxl={5} sm={6}>
          <FormGroup>

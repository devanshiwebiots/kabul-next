...
import { KabulMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, Name, Password } from "@/Constant";
import { StudentTabProp } from "@/Types/Forms";
  ...
  return (
    <Row className="g-3">
      ...
      <Col sm={6}>
        ...
        <Input name="email" onChange={getUserData} value={email} type="email" placeholder={KabulMail} />
      </Col>
      <Col xs={12}>

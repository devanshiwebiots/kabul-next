...
import { DeleteRowData } from "@/Types/Tables";
import { DeleteDataColumn, DeleteRowDataList } from "@/Data/Tables/DataTables/Api";
      ...
      <Card className="basic-data-table">
        ...
        <CardBody>
          <div className="table-responsive">
            {selectedRows.length !== 0 && (<Button onClick={handleDelete} className="mb-3">{DeleteSelectDataButton}</Button>
            )}

...
const UserProfileFourthSection = () => {
    return (
        <Col sm={12} >
            <Card>
                <div className="profile-img-style">
                    <Row className="g-2">
                        ...
                        <Col sm={4} className="align-self-center mt-0 text-end">
                            <CommonTourSocialMedia time="2 Years ago"  className='step9'/>
                        </Col>
                    </Row>
                    <hr />
                    <Row>
                        <Col lg={12} xl={4}>
                            <div id="aniimated-thumbnials-3">
                                <Link href={Href}><RatioImage className="img-fluid rounded" src={`${ImagePath}/other-images/sidebar-bg.jpg`} alt="nature" /></Link></div>
                        </Col>
                        <Col xl={6}>
...
export default UserProfileFourthSection

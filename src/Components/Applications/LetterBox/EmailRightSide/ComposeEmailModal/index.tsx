        ...
        <Form className="form-bookmark needs-validation" onSubmit={handleSubmit(onSubmitForm)}>
          ...
          <FormGroup>
            <Row>
              ...
              <Col sm={10}>
                <Input className={`${emailValidation && `${errors.userEmail ? "is-invalid":"is-valid"}`}`} type="email" {...register("userEmail", { required: true })} autoComplete="off"/>
          ...
          <FormGroup>
            <Row>
              ...
              <Col sm={10}>
                <Input className={`${emailValidation && `${errors.subject ? "is-invalid":"is-valid"}`}`} type="textarea" {...register("subject", { required: true })} autoComplete="off"/>
              </Col>
            </Row>
          </FormGroup>

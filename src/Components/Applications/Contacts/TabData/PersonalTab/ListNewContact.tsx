import { ListNewContactPropsType, UserCallbackUser } from '@/Types/Contact';
            ...
            return (
              <NavLink className={dynamicTab === index ? 'active' : ''} onClick={() => setDynamicTab(index)} key={index} >
                <div className='d-flex' onClick={() => ContactDetails(user)}>
                  <Image height={50} width={50} priority className='p-0 img-fluid m-r-20 rounded-circle update_img_0' src={`${user.avatar}`} alt='userImage' />

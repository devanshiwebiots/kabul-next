...
const Invoice5Address = () => {
  return (
    <td>
      <span style={{ fontSize: 18, display: "block", fontWeight: 600, color: "var(--theme-default)", marginBottom: 14 }} >{InvoiceTo} :</span>
      <span style={{ fontSize: 18, display: "block", fontWeight: 600, color: "rgba(0, 2, 72, 1)", marginBottom: 8 }} >Brooklyn Simmons</span>
...
export default Invoice5Address;

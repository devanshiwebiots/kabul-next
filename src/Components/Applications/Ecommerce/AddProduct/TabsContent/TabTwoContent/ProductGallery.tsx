...
const ProductGallery = () => {
  ...
  return (
    <div className="product-upload">
      ...
      <Dropzone onChange={(files)=>updateFiles(files)} value={files} maxFiles={1} header={false} footer={false} minHeight="80px" name="fileName1" className="dropzone bg-light-primary dz-clickable">

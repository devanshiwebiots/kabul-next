...
import CommonLogo from "../Pages/Authentication/Common/CommonLogo";
      ...
      <div className="login-main">
        <Form className="theme-form" onSubmit={(event) => formSubmitHandle(event)}>
          ...
          <FormGroup className="mb-0">
            ...
            <Link className="link" href={Routes.AuthPage.ForgetPassword}>{ForgotPassword}?</Link>
          ...
          <p className="mt-4 mb-0 text-center">{DontHaveAccount}
            <Link className="ms-2" href={Routes.AuthPage.RegisterSimple}>{CreateAccount}</Link>
          </p>
        </Form>
      </div>
    </div>

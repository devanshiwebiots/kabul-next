      ...
      <TabContent activeTab={basicTab} id="nav-tabContent">
        <TabPane tabId="1">
          <div className="d-flex mb-xl-4 list-behavior-1">
            <div className="flex-shrink-0"><RatioImage className="tab-img img-fluid w-auto" src={`${ImagePath}/blog/img.png`} alt="home" /></div>
          ...
          <div className="d-xl-flex list-behavior-1">
            ...
            <div className="flex-shrink-0"><RatioImage className="tab-img img-fluid w-auto" src={`${ImagePath}/blog/blog.jpg`} alt="home" /></div>
          </div>
        </TabPane>
        <TabPane tabId="2" className="dark-list">
          <div className="flex-space align-items-center list-light-dark contact-profile"><Image height={100} width={100} priority className="tab-img" src={`${ImagePath}/avtar/3.jpg`} alt="profile" />

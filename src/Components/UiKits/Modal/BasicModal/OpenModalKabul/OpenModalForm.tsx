import { EmailAddress, EnterYourFirstName, EnterYourLastName, FirstName, LastName, KabulEmail, SignUp, TermsAndCondition } from "@/Constant";
import { FormSchema } from "@/Data/UiKits/Modal";
import { FormSubmitProp } from "@/Types/UiKits";
            ...
            <Row>
              ...
              <Col md={12}>
                <FormGroup>
                  ...
                  <Field type="text" name="email" className={`form-control ${formSubmit && `${errors.email ? "is-valid" : "is-invalid"}`}`} placeholder={KabulEmail} />
                </FormGroup>
              </Col>
              <Col md={12}>
                <FormGroup check>
                  <Field className="form-check-input" type="checkbox" name="agree" />
                  <Label check>{TermsAndCondition}</Label>
                </FormGroup>

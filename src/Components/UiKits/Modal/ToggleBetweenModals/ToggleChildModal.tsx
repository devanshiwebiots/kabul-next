  ...
  return (
    <div className="modal-toggle-wrapper">
      <ul className="modal-img">
        <li className="text-center"><RatioImage src={`${ImagePath}/gif/logout.gif`} alt="logout" /></li>
      </ul>
      ...
      <span className="d-block text-center mb-4">Not a member?
        <Link className="ms-1" href={Routes.Dashboard.DefaultDashboard}>{ConnectNewRegisterAccount}</Link>
      </span>

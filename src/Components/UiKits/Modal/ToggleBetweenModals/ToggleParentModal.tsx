...
import { ToggleModalType } from "@/Types/UiKits";
  ...
  return (
    <div className="modal-toggle-wrapper">
      <ul className="modal-img">
        <li><RatioImage src={`${ImagePath}/gif/whatapp.gif`} alt="whatsapp" /></li>
        <li><RatioImage src={`${ImagePath}/gif/instagram.gif`} alt="instagram" /></li>
        <li><RatioImage src={`${ImagePath}/gif/facebook.gif`} alt="facebook" /></li>
      </ul>

      ...
      <TabContent activeTab={basicTab}>
        ...
        <TabPane tabId="2">
         ...
         <div className="flex-space flex-wrap align-items-center">
          <Image height={100} width={92} priority className="tab-img" src={`${ImagePath}/ecommerce/08.jpg`} alt="profile"/>
            ...
            <div className="main-inbox"> 
              <div className="header-inbox justify-content-start gap-2">
                <div className="header-left-inbox">
                  <div className="inbox-img"><Image height={50} width={50} priority src={`${ImagePath}/ecommerce/07.jpg`} alt="profile" /></div>
                </div>
